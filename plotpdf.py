...
# Replace this with your actual file containing all the lines
file_list_path = "/Users/oliverchen/Seismometer2/top50"  # Text file where each line has filepath + extra columns
